    ...
    <div className="relative overflow-hidden">
      <div className="absolute inset-y-0 right-0 flex">
        <button
          ...
          className="flex w-19 flex-col items-center justify-center gap-1 bg-primary text-xs font-medium text-white hover:bg-primary/90"
        >
          <Pencil className="size-4" />
          Editar
        </button>
        <button
          ...
          className="flex w-19 flex-col items-center justify-center gap-1 bg-danger text-xs font-medium text-white hover:bg-danger/90"
        >
          <Trash2 className="size-4" />
          Excluir
        </button>
